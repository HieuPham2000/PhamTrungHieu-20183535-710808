...
public class RushOrderInfoScreenHandler extends BaseScreenHandler implements Initializable {
	...
	public RushOrderInfoScreenHandler(Stage stage, String screenPath, Order order) throws IOException {
